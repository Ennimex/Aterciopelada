...
const ProductosScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Filtrar por búsqueda de texto en tiempo real
    if (searchQuery.trim()) {
      filtered = filtered.filter(producto =>
  ...
  }, [productos, selectedTalla, selectedLocalidad, soloDisponibles, searchQuery]);
          ...
          <View style={{ marginBottom: stylesGlobal.spacing.scale[3] }}>
            ...
            >
              ...
              <Ionicons
                ...
                size={20}
                color={stylesGlobal.colors.text.muted}
                style={{ marginRight: stylesGlobal.spacing.scale[2] }}
              />
